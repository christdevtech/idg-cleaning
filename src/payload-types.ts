...
export interface Config {
  ...
  globals: {
    header: Header;
    footer: Footer;
    'archive-heroes': ArchiveHero;
  };
  globalsSelect: {
    header: HeaderSelect<false> | HeaderSelect<true>;
    footer: FooterSelect<false> | FooterSelect<true>;
    'archive-heroes': ArchiveHeroesSelect<false> | ArchiveHeroesSelect<true>;
  };
  locale: null;
  user: User & {
    collection: 'users';
...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact' | 'dynamic';
    richText?: {
      root: {
        type: string;
        children: {
    ...
    /**
     * Control the layout and visibility of banner elements.
     */
    layoutSettings?: {
    ...
    marqueeWords?:
      ...
      | null;
    /**
     * Scroll speed for the marquee words (in seconds).
     */
    marqueeSpeedSeconds?: number | null;
    ...
    trustIndicators?: {
      ...
      partners?: {
        show?: boolean | null;
        /**
         * Upload partner avatars shown as a stacked group.
         */
        avatars?:
          | {
              image: string | Media;
    ...
    decorItems?:
      | {
          ...
          animationType?: ('float' | 'bob' | 'sway' | 'spin' | 'pulse') | null;
          speed?: ('slow' | 'normal' | 'fast') | null;
          delayMs?: number | null;
          id?: string | null;
        }[]
      | null;
    bannerGradient?: ('blue' | 'purple' | 'green') | null;
    curveOpacity?: number | null;
  };
  layout: (
    | CallToActionBlock
    | ContentBlock
...
export interface SplitFeatureBlock {
  ...
  leftTop?: (string | null) | Media;
  leftBottom?: (string | null) | Media;
  centerMedia?: (string | null) | Media;
  highlight?: {
...
export interface ServicesSliderBlock {
  ...
  useSelection?: ('all' | 'selected') | null;
  limit?: number | null;
  selectedDocs?:
    | {
        relationTo: 'services';
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "archive-heroes".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "archive-heroes_select".
 */
export interface ArchiveHeroesSelect<T extends boolean = true> {
  postsHero?:
    | T
    | {
        title?: T;
