...
type Props = {
  heroImage: MediaType | string
  title: string
  subtitle?: string
}

export const ArchiveHero: React.FC<Props> = ({ heroImage, title, subtitle }) => {
  return (
    <div className="relative flex items-end justify-center h-[60vh] min-h-[40rem] text-white">
